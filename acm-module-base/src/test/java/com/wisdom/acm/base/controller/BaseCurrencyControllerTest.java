...
public class BaseCurrencyControllerTest {
    private String url = "http://127.0.0.1:8780/currency";
     ...
     */
    @Test
    public void test2QueryCurrencyList() {
        String api = "/list";
     ...
     */
    @Test
    public void test2GetDefaultCurrency() {
        String api = "/defaultCurrency";
     ...
     */
    @Test
    public void test4DeleteCurrencyById() {
        String api = "/delete";
        int[] ids = {9999, 9999};
     ...
     */
    @Test
    public void test1AddCurrency() {
        String api = "/add";
        
        Map map = new HashMap<String, Object>();
        map.put("currencyCode", "currencyCode100");
        map.put("currencyName", "currencyName100");
        map.put("currencySymbol", "currencySymbol100");
     ...
     */
    @Test
    public void test2GetCurrencyById() {
        //String api = "/{id}/info";
     ...
     */
    @Test
    public void test3UpdateCurrency() {
        String api = "/update";
        Integer id = 1010;
