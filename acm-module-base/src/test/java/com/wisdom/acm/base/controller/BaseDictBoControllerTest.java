...
public class BaseDictBoControllerTest {
    private String url = "http://127.0.0.1:8780/digitDirBo";
     ...
     */
    @Test
    public void test2QueryDigitdirBoList() {
        //String api = "/{boType}/list";
        String api = "/boType/list";
