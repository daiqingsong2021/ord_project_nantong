...
/**
 * BaseTmplTaskDelvController Tester.
 *
 * @author hejian
 * @version 1.0
...
public class BaseTmplTaskDelvControllerTest {
    private String url = "http://127.0.0.1:8780/tmplTaskDelv";
     ...
     */
    @Test
    public void test2QueryTmplTaskDelvList() {
        //String api = "/{taskId}/list";
     ...
     */
    @Test
    public void test3AssignTmplTaskDelv() {
        String api = "/assign";
     ...
     */
    @Test
    public void test3UpdateTmplTaskDelv() {
        String api = "/update";
        Integer id = 1010;
        
        Map map = new HashMap<String, Object>();
        map.put("id", id);
        map.put("delvCode", "delvCode100");
        map.put("delvName", "delvName100");
        map.put("planNum", 9999);
        map.put("delvType", "delvType100");
     ...
     */
    @Test
    public void test4DeleteTmplTaskDelv() {
        String api = "/delete";
        int[] ids = {9999, 9999};
     ...
     */
    @Test
    public void test2QueryGbTypeInfo() {
        //String api = "/{id}/info";
