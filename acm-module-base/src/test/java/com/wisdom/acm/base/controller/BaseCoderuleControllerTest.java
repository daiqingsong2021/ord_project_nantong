...
public class BaseCoderuleControllerTest {
    private String url = "http://127.0.0.1:8780/coderule";
     ...
     */
    @Test
    public void test2GetCoderuleById() {
        //String api = "/{id}/info";
     ...
     */
    @Test
    public void test3QuerryCoderuleListByboId() {
     ...
     */
    @Test
    public void test1AddCoderule() {
        String api = "/add";
        
        Map map = new HashMap<String, Object>();
        map.put("ruleBoId", 9999);
        map.put("ruleName", "ruleName100");
        map.put("defaultFlag", 9999);
        map.put("modified", 9999);
     ...
     */
    @Test
    public void test3UpdateCoderule() {
        String api = "/update";
        Integer id = 1010;
