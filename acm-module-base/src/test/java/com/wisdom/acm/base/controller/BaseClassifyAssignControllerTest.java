...
/**
 * BaseClassifyAssignController Tester.
 *
 * @author hejian
 * @version 1.0
...
public class BaseClassifyAssignControllerTest {
    private String url = "http://127.0.0.1:8780/classifyAssign";
     ...
     */
    @Test
    public void test2QueryClassifyAssignList() {
        //String api = "/{boCode}/{boId}/list";
        String api = "/boCode/9999/list";
     ...
     */
    @Test
    public void test3AssignClassify() {
        String api = "/assign";
        
        Map map = new HashMap<String, Object>();
        map.put("classifyId", 9999);
        map.put("boCode", "boCode100");
        map.put("boId", 9999);
        map.put("classifyTypeId", 9999);
     ...
     */
    @Test
    public void test4DeleteClassifyAssign() {
        String api = "/delete";
        int[] ids = {9999, 9999};
