...
/**
 * BaseTmplTaskPredController Tester.
 *
 * @author hejian
 * @version 1.0
...
public class BaseTmplTaskPredControllerTest {
    private String url = "http://127.0.0.1:8780/tmplTaskPred";
     ...
     */
    @Test
    public void test2QueryTmplTaskPredList() {
        //String api = "/{taskId}/predList";
        String api = "/9999/predList";
     ...
     */
    @Test
    public void test2QueryTmplTaskFllowList() {
        //String api = "/{taskId}/fllowList";
        String api = "/9999/fllowList";
     ...
     */
    @Test
    public void test3AssignBaseTmplTaskPred() {
        String api = "/assign";
        
        Map map = new HashMap<String, Object>();
        map.put("taskId", 9999);
        map.put("predTaskId", 9999);
        map.put("relationType", "relationType100");
        map.put("lagQty", 9999);
     ...
     */
    @Test
    public void test3UpdateBaseTmplTaskPred() {
        String api = "/update";
        Integer id = 1010;
     ...
     */
    @Test
    public void test4DeleteBaseTmplTaskPred() {
        String api = "/delete";
        int[] ids = {9999, 9999};
