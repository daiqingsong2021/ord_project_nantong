...
public class BaseClassifyControllerTest {
    private String url = "http://127.0.0.1:8780/classify";
     ...
     */
    @Test
    public void test1AddClassify() {
        String api = "/add";
        
        Map map = new HashMap<String, Object>();
        map.put("parentId", 9999);
        map.put("boCode", "boCode100");
        map.put("classifyCode", "classifyCode100");
        map.put("classifyType", 9999);
     ...
     */
    @Test
    public void test2QueryClassifyList() {
        //String api = "/{boCode}/list";
        String api = "/boCode/list";
     ...
     */
    @Test
    public void test3UpdateClassify() {
        String api = "/update";
        Integer id = 1010;
     ...
     */
    @Test
    public void test2QueryClassifyInfo() {
        //String api = "/{classifyId}/info";
