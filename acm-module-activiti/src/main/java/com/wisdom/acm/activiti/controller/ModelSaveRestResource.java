...
public class ModelSaveRestResource implements ModelDataJsonConstants {
	...
	public void saveModel(@PathVariable String modelId, @RequestParam("name") String name,
		...
		try {
			...
			ObjectNode metaInfoJson = (ObjectNode) objectMapper.readTree(model.getMetaInfo());
			//metaInfoJson.put(MODEL_NAME, name); //存的key不在修改
			metaInfoJson.put(MODEL_DESCRIPTION, description);
