...
public class CustomProcessDiagramCanvas extends DefaultProcessDiagramCanvas {
    ...
    //font
    protected String activityFontName = WorkflowConstants.WORKLOW_FONT_NAME;
    protected String labelFontName = WorkflowConstants.WORKLOW_FONT_NAME;;
    protected String annotationFontName = WorkflowConstants.WORKLOW_FONT_NAME;;
