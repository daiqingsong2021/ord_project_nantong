package com.wisdom.acm.activiti.util.canvas;
...
@Service("customProcessDiagramGeneratorI")
public class CustomProcessDiagramGenerator extends DefaultProcessDiagramGenerator implements CustomProcessDiagramGeneratorI{
    ...
    static {
        new CustomProcessDiagramCanvas(10,10,0,0,"png", WorkflowConstants.WORKLOW_FONT_NAME,WorkflowConstants.WORKLOW_FONT_NAME,WorkflowConstants.WORKLOW_FONT_NAME,null);
    }
...
//          }
    ...
    protected static CustomProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        double maxY = 0;
        List<GraphicInfo> graphicInfos = new ArrayList<GraphicInfo>();
        ...
        for (FlowNode flowNode : flowNodes) {
            ...
            for (SequenceFlow sequenceFlow : flowNode.getOutgoingFlows()) {
                ...
                if (graphicInfoList != null) {
                    graphicInfos.addAll(graphicInfoList);
                }
            }
        }
