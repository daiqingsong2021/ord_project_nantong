...
@MapperScan({"com.wisdom.acm.dc4.mapper"})
...
@EnableSwagger2Doc
@EnableEncrypt
public class AcmModuleDc4Application {

	public static void main(String[] args) {
		SpringApplication.run(AcmModuleDc4Application.class, args);
	}
