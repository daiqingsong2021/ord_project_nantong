...
import com.wisdom.acm.dc4.common.officeUtils.ExcelError;
import com.wisdom.acm.dc4.common.officeUtils.ExcelUtil;
import com.wisdom.acm.dc4.mapper.wf.SysMessageMapper;
import com.wisdom.acm.dc4.mapper.menu.MenuMapper;
...
import com.wisdom.acm.dc4.service.wf.ActivitiTemplateService;
...
public class SzxmCommonUtil {
    ...
    public <T> void approveFlowAndSendMessage(String bizType, List<T> rawPos) {
        List<Integer> initiatorIds = ListUtil.toValueList(rawPos, "reviewer", Integer.class);
        ...
        for (T po : rawPos) {
            ...
            try {
                initTime = (Date)po.getClass().getMethod("getReviewTime").invoke(po);
            ...
            sysMessageAddForm.setTitle("施工日况--流程审批提醒");
