package com.wisdom.acm.wf.config;//package com.wisdom.acm.wf.config;
//
...
//    //static final String pCutStr = "execution(* com.wisdom.acm.wf.*..*(..))";
...
//    @Before(value = "execution(* com.wisdom.acm.wf.controller.*.*(..))")
...
//    @AfterReturning(value = "execution(* com.wisdom.acm.wf.controller.*.*(..))")
