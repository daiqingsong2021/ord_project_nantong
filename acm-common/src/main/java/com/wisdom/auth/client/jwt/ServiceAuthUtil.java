...
package com.wisdom.auth.client.jwt;

import com.wisdom.auth.client.config.ServiceAuthConfig;
import com.wisdom.auth.client.feign.ServiceAuthFeign;
...
public class ServiceAuthUtil{
    ...
    public void refreshAllowedClient() {
        ...
        ApiResult resp = serviceAuthFeign.getAllowedClient(serviceAuthConfig.getClientId(), serviceAuthConfig.getClientSecret());
        if (resp.getStatus() == 200) {
            ObjectRestResponse<List<String>> allowedClient = (ObjectRestResponse<List<String>>) resp;
            this.allowedClient = allowedClient.getObjectRestData();
        }
    }
    ...
    public void refreshClientToken() {
        ...
        ApiResult resp = serviceAuthFeign.getAccessToken(serviceAuthConfig.getClientId(), serviceAuthConfig.getClientSecret());
        if (resp.getStatus() == 200) {
            ObjectRestResponse<String> clientToken = (ObjectRestResponse<String>) resp;
            this.clientToken = clientToken.getObjectRestData();
        }
    }
