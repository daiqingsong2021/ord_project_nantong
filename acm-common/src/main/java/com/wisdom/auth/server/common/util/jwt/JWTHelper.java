...
import com.wisdom.auth.server.common.constatns.CommonConstants;
...
public class JWTHelper {
    ...
    public static String generateToken(IJWTInfo jwtInfo, String priKeyPath, int expire) throws Exception {
        String compactJws = Jwts.builder()
                ...
                .claim(CommonConstants.CONTEXT_KEY_ACTUNAME,jwtInfo.getActuName())
                .claim(CommonConstants.CONTEXT_KEY_USERTYPE,jwtInfo.getUserType())
