...
//            if (!ObjectUtils.isEmpty(messageFuture.getResultMessage()) && messageFuture.getResultMessage() instanceof GlobalBeginResponse) {
//                System.out.println("==>messageFuture ResultMessage xid: " + ((GlobalBeginResponse) messageFuture.getResultMessage()).getXid());
//            }
//
//            if (LOGGER.isDebugEnabled()) {
