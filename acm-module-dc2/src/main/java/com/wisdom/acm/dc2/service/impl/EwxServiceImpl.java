...
import com.wisdom.acm.dc2.common.JsonHelper;
import com.wisdom.acm.dc2.common.NeruSoftHttpsUtils;
import com.wisdom.acm.dc2.common.PropertiesLoaderUtils;
import com.wisdom.acm.dc2.common.redisUtils.RedisUtil;
import com.wisdom.acm.dc2.service.EwxService;
import com.wisdom.acm.dc2.vo.app.AppUserInfoVo;
import com.wisdom.acm.dc2.vo.app.KqRecordVo;
...
public class EwxServiceImpl implements EwxService
{
   ...
   //企业微信接口配置
     ...
     * @return
     */
    @Override public AppUserInfoVo getEwxAppUserInfo(String code)
    {
