...
@MapperScan({"com.wisdom.acm.dc2.mapper"})
...
@EnableSwagger2Doc
@EnableEncrypt
public class AcmModuleDc2Application {

	public static void main(String[] args) {
		SpringApplication.run(AcmModuleDc2Application.class, args);
	}
