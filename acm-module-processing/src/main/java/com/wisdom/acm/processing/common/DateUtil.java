...
public class DateUtil
{
    ...
    public static final String TIME_DEFAULT = "HH:mm";
    ...
    private static DateFormat timeFormat_ = null;
    ...
    static
    {
        ...
        timeFormat_=new SimpleDateFormat(TIME_DEFAULT);
    }
     ...
     * @return HH:mm
     */
    public static String getTimeFormat_(Date date)
    {
        return timeFormat_.format(date);
    }
     ...
     * @return
     */
    public static String formateNyrsfm(Date date){
...
//        return str6;
    ...
    public static void main(String args[])
    {
        ...
        // 指定格式化格式
        SimpleDateFormat f = new SimpleDateFormat("yyyy 年 MM 月 dd 日  HH 点 mm 分");
        System.out.println(f.format(now)); // 将当前时间袼式化为指定的格式
        System.out.println("2020-01-04".substring(0,7));
        ...
        System.out.println("赵连连-------------------------"+formateNyrsfm(new Date()));
        //Date now = new Date();
        Calendar cal = Calendar.getInstance();
        DateFormat d1 = DateFormat.getDateInstance(); //默认bai语言（汉语）下的默认风du格（MEDIUM风格，比如：2008-6-16 20:54:53）
        String str1 = d1.format(now);
        DateFormat d2 = DateFormat.getDateTimeInstance();
        String str2 = d2.format(now);
        DateFormat d3 = DateFormat.getTimeInstance();
        String str3 = d3.format(now);
        DateFormat d4 = DateFormat.getInstance(); //使用zhiSHORT风格显示日期dao和时间
       ...
       // System.out.println(year +"年"+ month +"月"+ day + "日"+ hour +"时"+ minute +"分"+ second +"秒");
        System.out.println(getNowTimeByChina(now));
    }
     ...
     * @return
     */
    public static String getNowTimeByChina(Date time){
        Calendar ca = Calendar.getInstance();
        ca.setTime(time);
        int year = ca.get(Calendar.YEAR);//获取年份
        int month=ca.get(Calendar.MONTH)+1;//获取月份
