...
public class SysMenuControllerTest {
    private String url = "http://127.0.0.1:8762/menu";
     ...
     */
    @Test
    public void test2QueryMenuTree() {
        String api = "/tree";
     ...
     */
    @Test
    public void test2QueryMenyBySearch() {
        String api = "/search";
     ...
     */
    @Test
    public void test2GetMenuInfo() {
        //String api = "/{menuId}/info";
    ...
    public void test3UpdateMenu() {
        ...
        map.put("menuCode", "menuCode100");
        map.put("menuName", "menuName100");
        map.put("shortCode", "shortCode100");
        map.put("url", "url100");
        map.put("image", "image100");
        map.put("i18n", "i18n100");
        map.put("hidden", 9999);
        map.put("share", 9999);
        map.put("isMenu", 9999);
        map.put("sort", 9999);
        map.put("menuDesc", "menuDesc100");
        map.put("active", 9999);
        map.put("menuType", 9999);
     ...
     */
    @Test
    public void test2QueryMenuTabs() {
        String api = "/menutab";
