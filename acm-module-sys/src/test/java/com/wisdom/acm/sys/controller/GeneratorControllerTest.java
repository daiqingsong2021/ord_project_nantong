...
public class GeneratorControllerTest {
    private String url = "http://127.0.0.1:8762/generator";
     ...
     */
    @Test
    public void test3TableCode() {
        String api = "/tablecode";
    ...
    public void test3Code() {
        ...
        tableNames.add("wsd_plan_taskchangeapply");

        map.put("tableList",tableNames);
        //
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON_UTF8);
        HttpEntity formEntity = new HttpEntity(map, headers);
